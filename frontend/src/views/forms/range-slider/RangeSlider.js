        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <code>&lt;input type="range"&gt;</code>, the Range Slider offers enhanced
              customization options, including multiple handles, labels, tooltips, and vertical
              orientation. It ensures consistent styling across browsers and provides a rich set of
